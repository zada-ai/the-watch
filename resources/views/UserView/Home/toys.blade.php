...
@section('title', 'Premium Toys - The Watch')

@section('content')

<div class="bg-gradient-to-r from-yellow-500 to-orange-500 py-6">
    <div class="max-w-7xl mx-auto px-4">
        <span class="text-white font-bold text-sm md:text-base">🎮 Explore Our Premium Toys Collection 🎮</span>
    </div>
</div>
...
@php
    ...
    if (!isset($products)) {
        $products = ToysProduct::where('active', true)
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 py-12">
        ...
        <!-- Page Header -->
        <div class="mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-2">Premium Toys Collection</h1>
            <p class="text-gray-600 text-lg">Quality and fun with our exclusive toy range</p>
        </div>

        <!-- Filter Buttons -->
        <div class="mb-8 flex gap-4">
            <button id="menBtn"
                class="px-8 py-3 bg-orange-500 text-white font-semibold rounded-lg transition-all"
                data-gender="men">
                ♂️ Men
            </button>
            <button id="womenBtn"
            ...
            <button id="allBtn"
                class="px-8 py-3 bg-yellow-500 text-white font-semibold rounded-lg transition-all"
                data-gender="all">
                All
            </button>
        </div>
...
">
     ...
     <img
                            ...
                            src="{{ $firstSrc }}"                            loading="lazy"                            data-images='@json($imagesForJs)'
                            data-index="0"
                 ...
                 <div class="p-2 sm:p-3 md:p-4">
                        ...
                        <div class="mt-4 flex gap-2">
                            <a href="{{ route('buy', ['type' => 'Toys', 'id' => $product->id]) }}" class="flex-1 inline-block text-center bg-orange-500 hover:bg-orange-600 text-white py-2 rounded-lg">Buy Now</a>
                            <a href="{{ route('toys') }}" class="flex-1 inline-block text-center border border-gray-200 text-gray-700 py-2 rounded-lg">View More</a>
                        </div>
                    </div>
                </div>
            ...
            @empty
                 <div class="col-span-full flex flex-col items-center justify-center py-20">
                    ...
                    <p class="text-gray-600 mb-6 max-w-2xl text-center">We're working on bringing a premium Toys collection to our store. Sign up for updates or explore our other categories meanwhile.</p>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateButtonStyles(activeGender) {
        menBtn.classList.toggle('bg-orange-500', activeGender === 'men');
        ...
        allBtn.classList.toggle('bg-yellow-500', activeGender === 'all');
    ...
    menBtn.addEventListener('click', () => {
        window.location.href = '{{ route("toys") }}?gender=men';
    });

    womenBtn.addEventListener('click', () => {
        window.location.href = '{{ route("toys") }}?gender=women';
    });

    allBtn.addEventListener('click', () => {
        window.location.href = '{{ route("toys") }}';
    });
