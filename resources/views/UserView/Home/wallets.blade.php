...
@section('title', 'Premium Wallets - The Watch')

@section('content')

<div class="bg-gradient-to-r from-blue-600 to-cyan-600 py-6">
    <div class="max-w-7xl mx-auto px-4">
        <span class="text-white font-bold text-sm md:text-base">👜 Explore Our Premium Wallets Collection 👜</span>
    </div>
</div>
...
@php
    ...
    if (!isset($products)) {
        $products = WalletsProduct::where('active', true)
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 py-12">
        ...
        <!-- Page Header -->
        <div class="mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-2">Premium Wallets Collection</h1>
            <p class="text-gray-600 text-lg">Style meets functionality with our exclusive wallet range</p>
        </div>
        ...
        <div class="mb-8 flex gap-4">
            ...
            <button id="allBtn"
                class="px-8 py-3 bg-cyan-600 text-white font-semibold rounded-lg transition-all"
                data-gender="all">
                All
            </button>
        </div>
...
">
                    ...
                    <div class="p-2 sm:p-3 md:p-4">
                        ...
                        <div class="mt-4 flex gap-2">
                            <a href="{{ route('buy', ['type' => 'wallets', 'id' => $product->id]) }}" class="flex-1 inline-block text-center bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg">Buy Now</a>
                            <a href="{{ route('wallets') }}" class="flex-1 inline-block text-center border border-gray-200 text-gray-700 py-2 rounded-lg">View More</a>
                        </div>
                    </div>
                </div>
            ...
            @empty
                  <div class="col-span-full flex flex-col items-center justify-center py-20">
                    ...
                    <p class="text-gray-600 mb-6 max-w-2xl text-center">We're working on bringing a premium Wallets collection to our store. Sign up for updates or explore our other categories meanwhile.</p>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateButtonStyles(activeGender) {
        ...
        womenBtn.classList.toggle('bg-purple-600', activeGender === 'women');
        ...
        allBtn.classList.toggle('bg-cyan-600', activeGender === 'all');
    ...
    menBtn.addEventListener('click', () => {
        window.location.href = '{{ route("wallets") }}?gender=men';
    });

    womenBtn.addEventListener('click', () => {
        window.location.href = '{{ route("wallets") }}?gender=women';
    });

    allBtn.addEventListener('click', () => {
        window.location.href = '{{ route("wallets") }}';
    });
