    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-auto">
            <div class="bg-white shadow-md p-6 border-b border-gray-200">
                <h1 class="text-3xl font-bold text-gray-800">Edit Airbud Entry</h1>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.airbuds.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="colors" value='{{ old('colors', json_encode($item->colors ?? [])) }}' placeholder="e.g. white:#ffffff, black:#000000" class="mt-1 block w-full border-gray-300 rounded-md">
