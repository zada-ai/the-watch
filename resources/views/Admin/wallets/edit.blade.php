    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-auto">
            <div class="bg-white shadow-md p-6 border-b border-gray-200">
                <h1 class="text-3xl font-bold text-gray-800">Edit Wallet Entry</h1>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.wallets.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
