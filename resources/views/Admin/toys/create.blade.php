    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-auto">
            <div class="bg-white shadow-md p-6 border-b border-gray-200">
                <h1 class="text-3xl font-bold text-gray-800">Create Toy Entry</h1>
            </div>
                ...
                <form action="{{ route('admin.toys.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="colors" value='{{ old('colors') }}' placeholder="e.g. red:#ff0000, blue:#0000ff" class="mt-1 block w-full border-gray-300 rounded-md">
...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-auto">
            <div class="bg-white shadow-md p-6 border-b border-gray-200">
                <h1 class="text-3xl font-bold text-gray-800">Add Toy Entry</h1>
            </div>
                ...
                <form action="{{ route('admin.toys.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="file" name="image_files[]" multiple accept="image/*" class="mt-1 block w-full">
                            <input type="text" name="images_text" value='{{ old('images_text') }}' placeholder="optional: path1.jpg, path2.jpg" class="mt-2 block w-full border-gray-300 rounded-md">
                            <p class="text-xs text-gray-500 mt-1">Uploaded files are saved to <strong>storage/toys</strong>. You can also paste existing paths (comma-separated) or JSON array.</p>
                        </div>
                        <div class="md:col-span-2">
