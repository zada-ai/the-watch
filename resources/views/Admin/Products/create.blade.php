                ...
                <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
                    <form action="{{ route('admin.products.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="discount" min="0" max="100" value="{{ old('discount', 0) }}" 
                                class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-amber-500">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="3" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-amber-500">{{ old('description') }}</textarea>
                        </div>

                        <!-- Colors (comma-separated) -->
                        <div class="mb-4">
                            <label class="block text-sm font-semibold mb-2">Colors (comma-separated hex codes)</label>
                            <input type="text" name="colors" placeholder="#111827, #b45309, #0369a1" value="{{ old('colors') }}" 
                                class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-amber-500">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="images" rows="3" placeholder="Landingpaginationimg/desktop_9.jfif, Landingpaginationimg/desktop_4.jfif" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-amber-500">{{ old('images') }}</textarea>
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="active" value="1" {{ old('active') ? 'checked' : '' }} class="mr-2">
