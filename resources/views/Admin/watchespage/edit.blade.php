...
<head>
    ...
    <title>Edit Watches Entry</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-auto">
            <div class="bg-white shadow-md p-6 border-b border-gray-200">
                <h1 class="text-3xl font-bold text-gray-800">Edit Watches Entry</h1>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.watchespage.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="sale_price" value="{{ old('sale_price', $item->sale_price) }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="checkbox" name="active" id="active" class="h-4 w-4 text-blue-600" {{ $item->active ? 'checked' : '' }}>
