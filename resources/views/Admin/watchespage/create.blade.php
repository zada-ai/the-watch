...
<head>
    ...
    <title>Create Watches Entry</title>
    ...
    <div class="flex h-screen">
        <div class="w-64 bg-gray-900 text-white p-6 flex flex-col">
            ...
            <nav class="flex-1 space-y-4">
                ...
                <a href="{{ route('admin.watchespage.index') }}" class="block px-4 py-2 rounded">⌚ WatchesPage</a>
            </nav>
        ...
        <div class="flex-1 overflow-auto">
            <div class="bg-white shadow-md p-6 border-b border-gray-200">
                <h1 class="text-3xl font-bold text-gray-800">Add Watches Entry</h1>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.watchespage.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="sale_price" value="{{ old('sale_price') }}" class="mt-1 block w-full border-gray-300 rounded-md">
                        </div>
                        <div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Uploaded files are saved to <strong>storage/watchespage</strong>. You can also paste existing paths (comma-separated) or JSON array.</p>
                        </div>
                        <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="checkbox" name="active" id="active" class="h-4 w-4 text-blue-600">
                    ...
                    <div class="mt-6">
                        ...
                        <a href="{{ route('admin.watchespage.index') }}" class="ml-4 text-gray-600">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
